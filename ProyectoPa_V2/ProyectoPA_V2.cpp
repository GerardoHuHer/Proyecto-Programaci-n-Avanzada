...
int main(){
  ...
  t4.join();
  t5.join();
  std::vector<Book> libros = lectureBook("/home/gd_15/Escritorio/CPP/Proyecto-Programaci-n-Avanzada/ArchivosLectura/books.csv"); // std::vector<Ratings> rat1 = lectureRating("/home/gerardohuerta1502/Escritorio/ProyectaPA_V2/ArchivosLectura/chunk_1.csv");
